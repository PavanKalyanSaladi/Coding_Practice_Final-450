'''
Minimum Jumps
Difficulty: MediumAccuracy: 11.91%Submissions: 789K+Points: 4
Given an array arr[] of size n of non-negative integers. 
Each array element represents the maximum length of the jumps
    that can be made forward from that element. 
    This means if arr[i] = x, then we can jump
...
Output: 2 
Explanation: First we jump from the 1st to 2nd element and then 
